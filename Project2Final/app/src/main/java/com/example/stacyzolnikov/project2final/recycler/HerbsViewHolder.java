 ...
 */
public class HerbsViewHolder extends RecyclerView.ViewHolder {
    public TextView mHerbName;
    ...
    public HerbsViewHolder(View itemView) {
        super(itemView);
        mHerbName = (TextView) itemView.findViewById(R.id.ItemNameID);
