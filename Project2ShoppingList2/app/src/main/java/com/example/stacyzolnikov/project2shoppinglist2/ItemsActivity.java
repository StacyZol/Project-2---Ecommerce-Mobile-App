...
public class ItemsActivity extends AppCompatActivity implements  PlaceHolderFragment.OnListItemClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.ShoppingCart:
                Intent intent = new Intent(ItemsActivity.this, ShoppingCartActivity2.class);
