...
public class Tree {
    ...
    public Tree(int id, String shirtName, String heart, String price, String shirtPhotosID, String storeNameShirt){
        this.id = id;
    ...
    public Tree(String shirtName, String heart, String price, String shirtPhotosID, String storeNameShirt){
        this.shirtName = shirtName;
        this.shirtPhotosID = shirtPhotosID;
        this.heart = heart;
        this.price = price;
